export const en = {
  ...
  stageCopilotWidget: {
    title: "Stage Copilot",
    close: "Close Stage Copilot",
    activeStage: "Active stage",
    detectedStage: "Detected stage",
    boundaryCopy: "No tools. No actions. Advisory conversation only.",
    promptStudioPlaceholder: "Ask about Prompt Studio and instructions...",
    sourcesContextPlaceholder: "Ask about Sources / Context...",
    stages: {
      prompt_studio: "Prompt Studio",
      sources_context: "Sources / Context",
    },
    chat: {
      ...
      fallbackNotice: "Fallback response is being shown because the provider is unavailable or failed.",
      errorTitle: "Chat request failed",
      missingMessage: "Ask about this stage...",
      unknownError: "Could not complete the chat request.",
    },
  },
  visual: {
    status: {
