...
function baseProfile(stageKey, overrides = {}) {
  const stagePrompt = {
    ...
    classification: {
      ...
      displayLabel: "Future native Stage Copilot PromptSpec",
  ...
  const capabilityPrompt = {
    ...
    classification: {
      ...
      renameAllowed: false,
      runtimeBehaviorChanged: false,
      displayLabel: "Capability PromptSpec",
  ...
  stageCopilotPromptSpecRefs: [
    {
      ...
      classification: {
        ...
        renameAllowed: false,
        runtimeBehaviorChanged: false,
        displayLabel: "Future Participant Evidence Stage Copilot PromptSpec",
      },
      linkedStage: "participant_evidence",
      status: "draft",
    },
    {
      ...
      classification: {
        ...
        renameAllowed: false,
        runtimeBehaviorChanged: false,
        displayLabel: "Current Pass 5 copilot-like prompt key",
        displayWarning: "Legacy/current key; not migrated or renamed.",
        legacyMapping: {
  ...
  stageCopilotPromptSpecRefs: [
    {
      ...
      classification: {
        ...
        renameAllowed: false,
        runtimeBehaviorChanged: false,
        displayLabel: "Current Pass 6 copilot-like prompt key",
        displayWarning: "Legacy/current key; not migrated or renamed.",
        legacyMapping: {
